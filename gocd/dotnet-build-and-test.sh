...
dotnet-sonarscanner begin /k:"TddPlayground" /d:sonar.host.url=https://sonarqube.rosprod.lnawsapps.co.uk /d:sonar.login=${SONAR_LOGIN} /d:sonar.cs.opencover.reportsPaths="coverage.opencover.xml" /d:sonar.exclusions="**/wwwroot/**/*"
dotnet build -c Release -property:Version=${GO_PIPELINE_LABEL}
cd TddPlayground.Test
